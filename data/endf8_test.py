...
## to be run from data folder within Scarabee
####################################################################################
##                         MODIFY LINES IN THIS BLOCK
base = "/home/st712/MaterialsLibrary/aceFiles/ENDF-B-VIII.0_neutrons/"
tslbase = "/home/st712/MaterialsLibrary/aceFiles/ENDF-B-VIII.0_thermal_scatt/"
...
# Set the default group structure
fdy.set_default_group_structure("SHEM-281")
fdy.set_default_max_legendre_moments(3) # (default: 3) might want to increase these 
...
N.label = N.name + " from ENDF/B-8.0"
N.temps = temps
N.dilutions = [1.0e10]  # Fission Product
N.process(h5)
